    ...
    def __init__(self):
        ...
        if DATABRICKS_SERVER_HOSTNAME and DATABRICKS_HTTP_PATH and DATABRICKS_TOKEN:
            try:
                ...
                print(
                    f"[ERROR] Databricks connection failed. Falling back to mock data: {e}"
                )
        else:
            print(
                "[WARNING] Databricks credentials not found in env. Using Mock Data mode for Hackathon UI."
            )
    ...
    def health_check(self) -> Dict[str, Any]:
        if not self.is_connected:
            return {
                ...
                or "Databricks credentials missing or invalid.",
            }
                ...
                with self.connection.cursor() as cursor:
                    ...
                    for i, r in enumerate(data):
                        ...
                        if i % 4 == 0:
                            ...
                            r["explanation_label"] = (
                                "🔴 BLOCK — Senior Underwriter Review"
                            )
                        else:
            ...
            records.append(
                {
                    ...
                    "model_prediction": round(
                        status[3] + random.uniform(-0.05, 0.05), 4
                    ),
